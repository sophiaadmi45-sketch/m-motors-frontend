...
export default function VehicleDossier() {
    ...
    const [form, setForm] = useState({ firstName: '', name: '', email: '', type: 'LLD', idFile: null, domFile: null, password: '' });
    const [liste, setListe] = useState([]);
    const [msg, setMsg] = useState('');

    const handleConnexionSuivi = async () => {
    ...
    const envoyer = async (e) => {
        ...
        if (res.ok) {
            ...
            setForm({ firstName: '', name: '', email: form.email, type: 'LLD', idFile: null, domFile: null, password: '' });
            e.target.reset();
        } else {
        ...
        <div className="dossier-box">
            ...
            {tab === 'form' ? (
                ...
                <div>
                    ...
                    <button className="btn btn-go-dashboard" onClick={handleConnexionSuivi}>
